...
const CourseDetailsRightSide = ({ courseData }) => {
  ...
  // disturcture data
  const { _id, price, tutor_name, enrolled, lectures, duration, payment } =
    courseData;
  // user
  const { user } = useAuth();
  // video popup
  ...
  useEffect(() => {
    if (_id && user.email) {
      fetch(
        `https://eduker-server.onrender.com/paymentInfo?email=${user?.email}&&id=${_id}`
      )
        .then((res) => res.json())
        .then((data) => {
        ...
        <div className="course__sidebar pl-70 p-relative">
          ...
          <div className="course__sidebar-widget-2 white-bg mb-20">
            <div className="course__video">
                ...
                <ul>
                  <li className="d-flex align-items-center">
                    ...
                    <div className="course__video-info">
                      <h5>
                        <span>Instructor :</span> {tutor_name}
                      </h5>
                    </div>
                  </li>
                  <li className="d-flex align-items-center">
              ...
              >
                Add To Cart <i className="fa-solid fa-cart-shopping ms-3"></i>{" "}
              </button>
